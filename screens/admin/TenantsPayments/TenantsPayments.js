    ...
    return (
      <View style={styles.cardContainer}>
        ...
        <View style={styles.propertyDetails}>
          ...
          <Text>
            <Text style={{ fontWeight: "bold" }}>Rent Name:</Text> {item?.rent}
          </Text>

          <Text>
            <Text style={{ fontWeight: "bold" }}>Area Fee:</Text>{" "}
            {item?.areaMaintainienceFee}
          </Text>

          <Text>
            <Text style={{ fontWeight: "bold" }}>Late Fee:</Text>{" "}
            {item?.lateFee}
          </Text>

          <Text>
            <Text style={{ fontWeight: "bold" }}>Month:</Text> {item?.month}
          </Text>
          ...
          <View style={styles.badgesContainer}>
            <View
              style={[
                styles.badge,
                {
                  backgroundColor: item.isPayable ? COLORS.red : COLORS.primary,
                  borderRadius: 8,
                },
              ]}
            >
              <Text style={styles.badgeText}>
                {item.isPayable ? "Payable" : "Payed"}
              </Text>
            </View>
            <View
              style={[
                styles.badge,
                {
                  backgroundColor: item.isLate ? COLORS.red : COLORS.primary,
                  borderRadius: 8,
                },
              ]}
            >
              <Text style={styles.badgeText}>
                {item.isLate ? "Late" : "In time"}
              </Text>
            </View>
          </View>
        </View>
    ...
    <View>
      ...
      >
        <View style={styles.formContainer}>
          ...
          <TextInput
            style={styles.inputstyle}
            placeholder="Enter Area Management Fee"
