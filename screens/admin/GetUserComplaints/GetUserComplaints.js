...
import { getAllComplaints } from "../../../API_Services/TenantsCompliants";
import {
  createPayments,
  deletePayments,
  getAllPayments,
...
const GetUserComplaints = () => {
  ...
  const getAllComplaintsList = async () => {
    console.log("hhhh");
    let userNamesResponse = await getAllComplaints(1, 10);
    ...
    return (
      <View style={styles.cardContainer}>
        ...
        <View style={styles.propertyDetails}>
          <Text>
            <Text style={{ fontWeight: "bold" }}>Complaint Id:</Text>{" "}
            {item?.complaintId}
          </Text>
          ...
          <Text>
            <Text style={{ fontWeight: "bold" }}>Complaint Date:</Text>{" "}
            {item?.complainDate}
          </Text>
          ...
          <View style={styles.badgesContainer}>
            <View
              style={[
                styles.badge,
                {
                  backgroundColor: item.isFixed ? COLORS.primary : COLORS.red,
                  borderRadius: 8,
                },
              ]}
            >
              <Text style={styles.badgeText}>
                {item.isFixed ? "Fixed" : "Pending"}
              </Text>
            </View>
          </View>
        </View>
